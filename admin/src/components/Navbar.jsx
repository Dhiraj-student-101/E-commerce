...
const Navbar = () => {
    ...
    // ✅ FIXED LOGOUT FUNCTION (Works on Laptop & Mobile)
    const logout = () => {
        navigate('/login')
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium border-b border-gray-200 px-4 sm:px-[5vw] bg-white sticky top-0 z-50'>
            ...
            <div className='flex items-center gap-6'>
                ...
                {/* ✅ FIXED PROFILE ICON & DROPDOWN (Works on Mobile Tap + Laptop Hover) */}
                <div className='relative group'>
                    ...
                    {/* Dropdown Menu */}
                    {token && (
                        <div className={`absolute right-0 pt-4 z-50 ${showProfileMenu ? 'block' : 'hidden group-hover:block'}`}>
                            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow-md border border-gray-200'>
                                ...
                                <p 
                                    ...
                                    className='cursor-pointer hover:text-black text-red-600 font-medium py-1'
                                >
                                    Logout
                                </p>
                            </div>
